...
//        setForeground(new Color(204, 93, 93));
    ...
    private void initComponents() {
        ...
        cmdForward = new gamm_DateChooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new gamm_DateChooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new gamm_DateChooser.Button();
        cmdPrevious = new gamm_DateChooser.Button();
        slide = new gamm_DateChooser.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gamm_DateChooser/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gamm_DateChooser/previous.png"))); // NOI18N
    ...
    private gamm_DateChooser.Button cmdForward;
    private gamm_DateChooser.Button cmdMonth;
    private gamm_DateChooser.Button cmdPrevious;
    private gamm_DateChooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private gamm_DateChooser.Slider slide;
